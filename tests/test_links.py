...
def test_fastai_prefix():
    ...
    expected = "functions for your application ([`fastai.vision`](/vision#vision))"
...
def test_respects_import_order():
    docstr = "`learner`"
    expected = "[`learner`](/vision.learner#vision.learner)"
    assert_link(docstr, expected, build_nb_cells(['fastai.text', 'fastai.vision']))

    expected_text = "[`learner`](/text.learner#text.learner)"
...
def test_nb_module_name_has_highest_priority():
    ...
    docstr = "`transform`"
    expected = "[`transform`](/text.transform#text.transform)"
    ...
    expected = "[`transform`](/tabular.transform#tabular.transform)"
...
In each case (except for [`collab`](/collab#collab)), the module is organized this way:
### [`transform`](/text.transform#text.transform)
### [`data`](/text.data#text.data)
### [`models`](/text.models#text.models)
### [`learner`](/text.learner#text.learner)"""
